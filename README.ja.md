...
> **v1.6.0の新機能：** フォーカスなしウィンドウ — 開いてもフォーカスを奪わなくなりました。アクセント正規化とタイポ耐性を備えた新しいRust検索エンジン。ウィンドウ位置プリセット。4つの新しいテキスト変換。[新機能を見る →](https://github.com/mnardit/beetroot-releases/releases/tag/v1.6.0)
