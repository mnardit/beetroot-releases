...
<p align="center">
  <a href="README.md">English</a> · <b>Русский</b> · <a href="README.de.md">Deutsch</a> · <a href="README.es.md">Español</a> · <a href="README.zh.md">中文</a>
</p>
...
|---|---|---|
| История | 25 элементов, пропадает после перезагрузки | Без ограничений, хранится всегда |
...
- **Быстрая вставка** — `Ctrl+1..9` для вставки последних элементов без открытия окна
...
| `Enter` | Вставить выбранный элемент |
