...
> **Новое в v1.6.0:** Окно без фокуса — Beetroot больше не перехватывает фокус при открытии. Новый поисковый движок на Rust с нормализацией акцентов и толерантностью к опечаткам. Пресеты позиции окна. 4 новых текстовых трансформации. [Что нового →](https://github.com/mnardit/beetroot-releases/releases/tag/v1.6.0)
